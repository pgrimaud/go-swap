...
final class Version20251227130458 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_pokemon (id INT AUTO_INCREMENT NOT NULL, has_normal TINYINT DEFAULT 0 NOT NULL, has_shiny TINYINT DEFAULT 0 NOT NULL, has_shadow TINYINT DEFAULT 0 NOT NULL, has_purified TINYINT DEFAULT 0 NOT NULL, has_lucky TINYINT DEFAULT 0 NOT NULL, has_xxl TINYINT DEFAULT 0 NOT NULL, has_xxs TINYINT DEFAULT 0 NOT NULL, has_hundo TINYINT DEFAULT 0 NOT NULL, first_caught_at DATETIME NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, user_id INT NOT NULL, pokemon_id INT NOT NULL, INDEX IDX_3AD18EF9A76ED395 (user_id), INDEX IDX_3AD18EF92FE71C3E (pokemon_id), UNIQUE INDEX user_pokemon_unique (user_id, pokemon_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
